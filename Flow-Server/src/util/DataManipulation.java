...
public class DataManipulation {
     ...
     *
     * @param directoryId the UUID, in String form, of the directory which to generate
     *                    the path of.
     * @return the path to the specified directory, starting with a
     * {@link File#separator file seperator} character.
     * @throws DatabaseException if the directory doesn't exist or there is an error accessing
     *                           the database.
     */
    public static String getDirectoryPath(String directoryId) throws DatabaseException {
        ...
        do {
            ...
            try {
                parentDirectoryId = Results.toStringArray("ParentDirectoryID", SQLDatabase.getInstance().getDirectoryInfo(directoryId))[0];
     ...
     *
     * @param fileId the UUID, in String form, of the file which to generate the
     *               path of.
     * @return the path to the specified file.
     * @throws DatabaseException if the file doesn't exist or there is an error accessing the
     *                           database.
     */
    public static String getFilePath(String fileId) throws DatabaseException {
        ...
        String parentDirectoryId = null, directoryId;
        try {
     ...
     *
     * @param uuids String objects consisting of string representations of UUIDs.
     * @return a UUID array derived from the string objects.
     * @throws IllegalArgumentException If an on the Strings in the array do not conform to the
