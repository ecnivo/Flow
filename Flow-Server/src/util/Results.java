...
public class Results {
    ...
    public static String[][] toStringArray(String[] columnNames, ResultSet results) throws SQLException {
    ...
    public static String[][] toStringArray(int[] columnNumbers, ResultSet results) throws SQLException {
        LinkedList<String[]> list = new LinkedList<>();
        while (results.next()) {
