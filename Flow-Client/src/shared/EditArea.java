...
public class EditArea extends JTextPane {
     ...
     *
     * @param textDoc         the text of the document to load on start
     * @param projectUUID     the UUID of its parent project
     * @param fileUUID        the UUID of the specific file
     * @param versionTextUUID the UUID of the version
     * @param editable        if this should be editable
     * @param tabs            the parent EditTabs
     */
    ...
    private class StyleBlock {
         ...
         * @param firstIdx the index of the block
         */
