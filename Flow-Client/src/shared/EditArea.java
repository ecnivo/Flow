...
public class EditArea extends JTextPane {
	...
	private final static int		PASTE_LIMIT		= 1500;
...
//				if (strLen > PASTE_LIMIT) {
//					int iterations = strLen / PASTE_LIMIT;
//					for (int segment = 0; segment < iterations - 1; segment++) {
//						String split = insertedString.substring(segment * PASTE_LIMIT, (segment + 1) * PASTE_LIMIT);
//						if (!sendUpdate(fileUUID, caretPos + segment * PASTE_LIMIT, split)) {
//							return;
//						}
//						sendUpdate(fileUUID, caretPos, insertedString.substring(iterations * PASTE_LIMIT));
//					}
//
//				} else {
					sendUpdate(fileUUID, caretPos, insertedString);
//				}
			...
			/**
			 * Sends an update of file_text_modify
			 * @param fileUUID the UUID of the file
			 * @param caretPos the insertion point
			 * @param insertString the String to insert
			 * @return whether or not it was inserted successfully
			 */
			private boolean sendUpdate(UUID fileUUID, int caretPos, String insertString) {
				...
				fileModify.put("str", insertString);
